        ...
        {success ? (
          ...
          <div className="text-center py-8">
            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="fa-solid fa-check text-rejimde-green text-3xl"></i>
            </div>
            <h3 className="text-xl font-extrabold text-gray-800 mb-2">Mesajınız Gönderildi!</h3>
            <p className="text-gray-500 font-bold text-sm mb-6">Uzman en kısa sürede yanıtlayacaktır.</p>
            <button 
              onClick={handleClose}
              className="bg-rejimde-blue text-white px-6 py-3 rounded-xl font-extrabold text-sm shadow-btn shadow-blue-300 btn-game hover:bg-blue-600 transition"
            >
              Tamam
            </button>
          </div>
          ...
          <>
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl text-sm font-bold mb-4">
                ...
                {/* Show alternative action for non-client error */}
                {errorCode === 'no_relationship' && (
                  <div className="mt-3 pt-3 border-t border-red-200">
                    <p className="text-xs text-red-500 mb-2">
                      Bu uzmana mesaj gönderebilmek için önce randevu almanız gerekmektedir.
                    </p>
                    <button
                      onClick={handleClose}
                      className="bg-red-600 text-white px-4 py-2 rounded-lg font-bold text-xs hover:bg-red-700 transition w-full"
                    >
                ...
                {/* Show login action for unauthorized error */}
