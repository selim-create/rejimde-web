...
import ContentEndNewsletterPlacement from "@/components/newsletter/ContentEndNewsletterPlacement";
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen pb-20 relative font-sans text-rejimde-text">
      ...
      <ContentEndNewsletterPlacement
        source="rejimde_blog_inline"
        selector="article .prose"
        title="Okuma burada bitmesin."
        description="Haftanın iyi yaşam yazıları, pratik öneriler ve uzman seçkileri e-postana gelsin."
        className="mt-8"
      />
    </div>
  );
