...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Rejimde",
    images: [{ url: "https://rejimde.com/og-blog.jpg", width: 1200, height: 630, alt: "Rejimde Blog - Sağlıklı Yaşam Rehberi" }],
  },
  twitter: {
  ...
  alternates: { canonical: "https://rejimde.com/blog" },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <>
      ...
      <LegacySidebarNewsletterBridge
        source="rejimde_blog_sidebar"
        title="Haftanın iyi yaşam seçkisi"
        description="En iyi yazılar, pratik öneriler ve uzman içerikleri e-postana gelsin."
      />
    </>
  );
}
