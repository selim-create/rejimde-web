...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Rejimde",
    images: [{ url: "https://rejimde.com/og-exercises.jpg", width: 1200, height: 630, alt: "Rejimde Egzersiz Programları" }],
  },
  twitter: {
  ...
  alternates: { canonical: "https://rejimde.com/exercises" },
  robots: {
    index: true,
    follow: true,
...
const jsonLd = {
  ...
  url: "https://rejimde.com/exercises",
  publisher: { "@type": "Organization", name: "Rejimde", logo: { "@type": "ImageObject", url: "https://rejimde.com/logo.png" } },
  inLanguage: "tr-TR",
  mainEntity: {
    "@type": "ItemList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "HIIT Programları" },
      { "@type": "ListItem", position: 2, name: "Kardiyo Egzersizleri" },
      { "@type": "ListItem", position: 3, name: "Yoga & Pilates" },
      { "@type": "ListItem", position: 4, name: "Güç Antrenmanı" },
    ],
  },
};
  ...
  return (
    <>
      ...
      <LegacySidebarNewsletterBridge
        source="rejimde_exercise_sidebar"
        title="Hareket notları"
        description="Yeni antrenmanlar, program fikirleri ve sürdürülebilir hareket önerileri e-postana gelsin."
      />
    </>
  );
}
