    ...
    const options: HipostaNewsletterOption[] = rows
      ...
      .map((row) => {
        ...
        return {
          ...
          publicationBrandColor: typeof publication?.brand_color === 'string' ? publication.brand_color : '#58cc02',
          ...
          accentColor: typeof row.accent_color === 'string' ? row.accent_color : '#58cc02',
          isPrimary: publicationSlug === 'rejimde',
        };
      });
